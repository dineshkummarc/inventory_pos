...
<div align="center"><font color="black"><h2>Inventory Report For&nbsp;<?php echo $_POST['term']; ?>
<strong> <?php echo $_POST['name']; ?>,</strong><strong> <?php echo $_POST['nam']; ?>
</font></h2>
...
$year=$today['year'];
	...
	echo "<center><table width='800px' border='0' class='tbody' cellpadding='3'>";
		echo "<tr class='thead'> 
		<th>Product Code</th>
		<th>Name</th>
		<th>Quantity</th>
...
echo "</table>";
		...
		echo "<h1>Total Income:Php <font color='red'>$add</h1>";
?>
<style type="text/css">
table, td, th
{
